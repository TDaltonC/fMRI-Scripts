[Subject Period Stage Condition Event Onset Duration ...
    Up	Down Bet1 Bet2 Bet3 Winout1 Winout2 Winout3 pwin1 pwin2 pwin3 plose1 plose2 plose3] = ...
    textread('C:\fMRI data\DCJ\SPM\data\log\dcj_dynamic_for_matlab_abs_gain_loss_spread.txt', ...
    '%d %d %d %d %s %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d', ...
    'headerlines', 1);

statdir = 'C:\fMRI data\DCJ\SPM\stat\Model_0005.2\FFX';
...
for Subj = unique(Subject)'
    ...
    for iRuns = 1:numel(Runs)
        ...
        onsets{n} = Onset(i);
        durations{n} = 0.5;
        pmod(n).name{1} = 'plose1';
        pmod(n).param{1} = plose1(i);
        pmod(n).poly{1} = 1;
        ...
        onsets{n} = Onset(i);
        durations{n} = 0.5;
        pmod(n).name{1} = 'plose2';
        pmod(n).param{1} = plose2(i);
        pmod(n).poly{1} = 1;
        ...
        onsets{n} = Onset(i);
        durations{n} = 0.5;
        pmod(n).name{1} = 'plose3';
        pmod(n).param{1} = plose3(i);
        pmod(n).poly{1} = 1;
