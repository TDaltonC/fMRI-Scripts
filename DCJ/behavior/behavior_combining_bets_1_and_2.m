...
W1 = (Winout1 == 1) & strcmp(Event, 'outcome_3'); 
W2 = (Winout2 == 1) & strcmp(Event, 'outcome_3');
W3 = (Winout3 == 1) & strcmp(Event, 'outcome_3');

%This creates the loss condition.

L1 = ((Winout1 == 0) & strcmp(Event, 'outcome_3')); 
L2 = ((Winout2 == 0) & strcmp(Event, 'outcome_3') & (Bet2 < 100));
L3 = ((Winout3 == 0) & strcmp(Event, 'outcome_3'));
...
Changew = vertcat(Change1w,Change2xw);
Changel = vertcat(Change1l,Change2xl);
...
v(1,:) = {'Change1' 'Change2' 'Change1w' 'Change1l' ...
          ...
          'Change2xl' 'Change2wl' 'Change2ll' 'Changew' 'Changel'};
