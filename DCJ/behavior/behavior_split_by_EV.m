...
W1 = (Winout1 == 1) & strcmp(Event, 'outcome_3') & (Up - Down < 0); 
W2 = (Winout2 == 1) & strcmp(Event, 'outcome_3') & (Up - Down < 0);
W3 = (Winout3 == 1) & strcmp(Event, 'outcome_3') & (Up - Down < 0);

%This creates the loss condition.

L1 = (Winout1 == 0) & strcmp(Event, 'outcome_3') & (Up - Down < 0); 
L2 = (Winout2 == 0) & strcmp(Event, 'outcome_3') & (Up - Down < 0);
L3 = (Winout3 == 0) & strcmp(Event, 'outcome_3') & (Up - Down < 0);
