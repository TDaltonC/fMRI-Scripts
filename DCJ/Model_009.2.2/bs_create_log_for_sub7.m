...
statdir = 'C:\fMRI data\DCJ\SPM\stat\Model_0009.2.2\FFX';
...
%Bet Increase     
 ...
 %Bet Decrease       
        ...
        l = ((Subject == Subj) & ismember(Period, Runs{iRuns}) & ...
            (strcmp(Event, 'outcome_3') & (Winout3 == 1))); 
        i = (j|k|l);
        onsets{n} = Onset(i);
        durations{n} = 0.5;

        %this is to clear out the variables incase they change size.
        clear j k l i jnum knum p
        ...
        l = ((Subject == Subj) & ismember(Period, Runs{iRuns}) & ...
            (strcmp(Event, 'eoutcome_3') & (Winout3 == 0)));
        i = (j|k|l);
        onsets{n} = Onset(i);
        durations{n} = 0.5;
